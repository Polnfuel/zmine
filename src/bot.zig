...
pub fn init(w: u8, h: u8, m: u16, cache: *stl.vec.vecneis, print_func: *const fn (*std.io.Writer, stl.vec.vec8, u8) std.io.Writer.Error!void, stdout: *std.io.Writer) !void {
...
pub fn clicks(field: stl.vec.vec8) !stl.vec.dvec16 {
    ...
    try print_field(buffer, prob_field, Probs.field_width);
